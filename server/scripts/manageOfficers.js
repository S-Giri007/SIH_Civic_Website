...
const showHelp = () => {
  ...
  console.log('\nUsage: node server/scripts/manageOfficers.js <command> [args]');
};
    ...
    switch (command) {
      ...
      case 'verify':
        if (!args[1]) {
          ...
          console.log('Usage: node server/scripts/manageOfficers.js verify <username>');
        } else {
      ...
      case 'details':
        if (!args[1]) {
          ...
          console.log('Usage: node server/scripts/manageOfficers.js details <username>');
        } else {
